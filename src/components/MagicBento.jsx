...
import { FiLayout, FiCode, FiLayers, FiZap, FiArrowRight } from 'react-icons/fi';
import './MagicBento.css';

const DEFAULT_PARTICLE_COUNT = 12;
const DEFAULT_SPOTLIGHT_RADIUS = 300;
const DEFAULT_GLOW_COLOR = '201, 251, 0';
...
const cardData = [
  {
    ...
    title: 'UI/UX Design',
    icon: FiLayout,
    description: 'Creating intuitive interfaces with seamless user experiences that drive engagement.',
  ...
  },
  {
    ...
    icon: FiCode,
    description: 'Building powerful web applications without writing code, using modern platforms.',
  ...
  },
  {
    ...
    title: 'Web Design',
    icon: FiLayers,
    description: 'Crafting visually stunning, responsive websites that captivate and convert.',
    tags: ['Landing Pages', 'Responsive', 'Figma to Code'],
    color: '#FFD93D'
  },
  {
    number: '04',
    title: 'Vibe Coding',
    icon: FiZap,
    description: 'AI-assisted rapid prototyping and development for lightning-fast MVP launches.',
    tags: ['AI Integration', 'Rapid Prototyping', 'MVP Launch'],
    color: '#FF61F6'
  }
];
...
const MagicBento = ({
  ...
  return (
    <>
      ...
      <div className="card-grid services-grid" ref={gridRef}>
        {cardData.map((card, index) => {
          ...
          return (
            <ParticleCard
              ...
              style={{ '--glow-color': glowColor, '--card-accent': card.color }}
            >
              <div className="magic-bento-card__header">
                <span className="magic-bento-card__number">{card.number}</span>
              </div>
              <div className="magic-bento-card__content">
                ...
                <div className="magic-bento-card__tags">
                  {card.tags.map((tag, i) => (
                    <span key={i} className="magic-bento-card__tag">{tag}</span>
                  ))}
                </div>
              </div>
              <div className="magic-bento-card__arrow">
                <FiArrowRight />
              </div>
            </ParticleCard>
          );
